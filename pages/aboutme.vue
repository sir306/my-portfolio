...
export default {
  ...
  data() {
    return {
      ...
      longBlurb: [
        {
          ...
          paragraph2:
            "While this injury was repaired and fit for duty I decided to go skiing and ended up epically wiping out and bending my knee 90 degrees in the wrong way (I know Ouch! Eww!) which kind of ended my journey in the world of a physically demanding work, so I was left with a broken leg for some time and had to figure out what I can do to make myself a career in something I’d enjoy doing, be able to provide for my family, and finally something that would stimulate me mentally. Which after evaluating the choices I had was an easy one to figure out as I had always wanted to get into coding.",
          paragraph3:
      ...
      currentEmployment: [
        { employmentStatus: "Currently Seeking Employment or Internship" },
      ],
    };
  },
